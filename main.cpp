/*
Description:
This file manages antique car data using Binary Search Tree (BST) and Hash Table data structures. 
It handles file operations, user input, and various functionalities like adding, deleting, and searching cars.
Additional features include undoing deletions, displaying data structures, and saving to files.
Integrates modules for comprehensive data management. 
*/
...
I created the design of the data structures and coordinated them with the project. 
Furthermore, I created menus and related functions in the main. I coordinated the team for weekly reports and reminded them of the deadlines.
After everyone did their own part, I ensured all parts of our project fit together smoothly, and I arranged and tested everything thoroughly.
I corrected every missing part of the code, such as adding comment lines at the top of the functions that describe their purpose. 
I submitted each week's report, presentation poster, and presentations. 
I gave feedback to my team members, and I helped them solve their coding problems.

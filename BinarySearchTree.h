...
PROGRAMMER - BEN KATZIR
    ...
    could be used to store data (antiqueCar items) for the project. In addition 
    to storing data, a crucial role of the BST in the project was also the visualization
    of data (provided by inorder and indented tree display) as well as testing/debugging
    tasks like delete, insert, and search which were created with other parts of the
    project (hash table and stack). Displaying the indented tree was especially helpful
    when debugging our delete and insert from file options.
*/
